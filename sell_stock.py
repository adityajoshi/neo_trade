...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Sell stock')
    parser.add_argument('--symbol', required=True, help='Stock symbol to sell')
    parser.add_argument('--qty', required=True, help='Stock Quantity to sell')
